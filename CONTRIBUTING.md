...
Пожалуйста, ознакомьтесь и следуйте нашему файлу [Code of Conduct](CODE_OF_CONDUCT.md).
...
Мейнтейнеры могут отклонять PR, если нарушается [кодекс поведения](CODE_OF_CONDUCT.md) или если стоимость поддержки изменений превышает пользу.
