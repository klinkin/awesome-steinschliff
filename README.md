...
| [P11-1](schliffs/fischer/P11-1.yaml) | чуть холоднее чем P11-2 | all | 0 -10 |  | универсальный, средняя температура | [P11-2](schliffs/fischer/P11-2.yaml), [P5-1](schliffs/fischer/P5-1.yaml) |
...
| [P22-6](schliffs/fischer/P22-6.yaml) | переходная структура на любой тип снега, температура от +5 до -5 | all | +5 -5 |  | универсальный, переходная структура, широкий диапазон | [P5-1](schliffs/fischer/P5-1.yaml), [P11-2](schliffs/fischer/P11-2.yaml) |
| [P5-1](schliffs/fischer/P5-1.yaml) | универсальная структура для любого типа снега на температуру от +5 до -10 | all | +5 -10 |  | универсальный, широкий диапазон |  |
...
| [M61B](schliffs/madshus/M61В.yaml) | универсальная структура для различных видов снега, в том числе и нового,  при температуре воздуха от +3 до -3 | all, universal, wet | +3 -3 |  | свежий снег, универсальный, трансформированный | [SV100](schliffs/serviccer/SV100.yaml) |
...
| [M62](schliffs/madshus/M62.yaml) | структура для для нового, перемешанного и крупнозернистого снега при высокой влажности, при температуре от -2 и теплее |  | +10 -2 |  | высокая влажность, свежий, перемешанный, крупнозернистый |  |
...
| Название | Описание | Тип снега | Температура | Изображение | Теги | Похожие структуры |
|------|------------|-----------|------------|------|-------------------|-------------------|
| [OH3](schliffs/ramsau/OH3.yaml) | структура на переходку и тепло при температуре от +5 до -7 | all | +5 -7 |  |  | [B3312](schliffs/beme/B3312.yaml) |
...
| [R2](schliffs/ramsau/R2.yaml) | структура на средний холод при температуре от -5 до -15 | all, frozen | -5 -15 |  | ramsau |  |
...
| [SV100](schliffs/serviccer/SV100.yaml) | стурктура для глянца, старого и свежего снег, замыленный снега и температуры от +3 до -3 | fresh, old, glossy | +3 -3 |  | глянец, замыленный |  |
...
| [P51-33](schliffs/svecky/P51-33.yaml) | Универсальная структура, не любит мелкий свежий снег | all, transformed, old | +2 -9 |  | универсальная, трансформированный снег |  |
| [PRG](schliffs/svecky/PRG.yaml) | Структура на трансформированный, ратрачный снег на средне-холодные температуры | transformed, groomed | -5 -13 |  | трансформированный снег, ратрачный снег, холодная |  |
...
| [VT1.3](schliffs/svecky/VT1.3.yaml) | Холодная структура, хорошо работает в раскат | used, transformed | -4 -16 |  | холодная, раскат, трансформированный снег |  |
| [VT3-2](schliffs/svecky/VT3-2.yaml) | Структура на свежий снег при холодных температурах | fresh, new | -3 -12 |  | свежий снег, холодная, новый снег |  |
| [VT322](schliffs/svecky/VT322.yaml) | Структура для классики на мелкозернистый и свежий снег | fine, fresh | 0 -16 |  | классический стиль, мелкозернистый снег, свежий снег |  |
