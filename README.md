...
| Название | Описание | Тип снега | Температура | Теги | Похожие структуры |
|------|------------|-----------|------------|------|-------------------|
| [W28](schliffs/skipole/W28.yaml) | переходная структура на любой тип снега при температуре от +3 до -3 | all | +3 -3 | переходная | [SV100](schliffs/serviccer/SV100.yaml), [F1](schliffs/marsport/F1.yaml) |
